...
namespace AIMLbot
{
	...
	public class Bot
	{
		...
		public void loadAIMLFromFiles(string pathAIML)
		{
			AIMLLoader loader = new AIMLLoader(this);
			//string pathSubstitutions = Path.GetDirectoryName(pathAIML);
			loader.loadAIML(pathAIML);
		}
		/// <summary>
		...
		private ResultHtml ProcessTagToHtml(XmlNode node)
		{
			...
			if (tagName == "html")
			{
				if (node.HasChildNodes)
				{
					...
					Render render = new Render(color, srcImageBot);
					...
					StringBuilder sbTemplateBtnMenu = new StringBuilder();


					sbTemplateBtnMenu.AppendLine("<div class=\"_4xko _2k7w _4xkr\">");
					sbTemplateBtnMenu.AppendLine("                                                                                        <div class=\"_2k7x\">");
					sbTemplateBtnMenu.AppendLine("                                                                                            <div class=\"_6b7s\">");
					//sbTemplateBtnMenu.AppendLine("                                                                                                <div class=\"_6isd _6ir5\">");
					//sbTemplateBtnMenu.AppendLine("                                                                                                    <div class=\"_4bqf _6ir3\">");
					//sbTemplateBtnMenu.AppendLine("                                                                                                        <a class=\"_6ir4\" href=\"#\" style=\"color: rgb(234, 82, 105);\">Sở hữu trí tuệ</a>");
					//sbTemplateBtnMenu.AppendLine("                                                                                                    </div>");
					//sbTemplateBtnMenu.AppendLine("                                                                                                </div>");
					//sbTemplateBtnMenu.AppendLine("                                                                                                <div class=\"_6ir5\">");
					//sbTemplateBtnMenu.AppendLine("                                                                                                    <div class=\"_4bqf _6ir3\">");
					//sbTemplateBtnMenu.AppendLine("                                                                                                        <a class=\"_6ir4\" href=\"#\" style=\"color: rgb(234, 82, 105);\">Thuế - Phí - Lệ phí</a>");
					//sbTemplateBtnMenu.AppendLine("                                                                                                    </div>");
					//sbTemplateBtnMenu.AppendLine("                                                                                                </div>");
					//sbTemplateBtnMenu.AppendLine("                                                                                                <div class=\"_6ir5\">");
					//sbTemplateBtnMenu.AppendLine("                                                                                                    <div class=\"_4bqf _6ir3\">");
					//sbTemplateBtnMenu.AppendLine("                                                                                                        <a class=\"_6ir4\" href=\"#\" style=\"color: rgb(234, 82, 105);\">Du lịch</a>");
					//sbTemplateBtnMenu.AppendLine("                                                                                                    </div>");
					//sbTemplateBtnMenu.AppendLine("                                                                                                </div>");
					sbTemplateBtnMenu.AppendLine("                                                                                            </div>");
					sbTemplateBtnMenu.AppendLine("                                                                                        </div>");
					...
					foreach (XmlNode childNode in node.ChildNodes)
					{
						...
						else
						{
							...
							{
								case "button":
									if (childNode.OuterXml.Contains("<menu>"))
									{
							...
							{
								result.ButtonPostback.Add(tagHtml.ButtonPostback);
							}
					...
					if (result.ButtonPostback.Count != 0)
					{
						...
						foreach (var item in result.ButtonPostback)
						{
							sbPostback.AppendLine(item);
						}
						//sbPostback.AppendLine("                                                                                    <div class=\"_2zgz\">");
						//sbPostback.AppendLine("                                                                                        <div class=\"_4bqf _6biq _6bir\" tabindex=\"0\" role=\"button\" style=\"border-color: rgb(234, 82, 105); color: rgb(234, 82, 105);\">Hủy</div>");
						//sbPostback.AppendLine("                                                                                    </div>");
						//sbPostback.AppendLine("                                                                                    <div class=\"_2zgz\">");
						//sbPostback.AppendLine("                                                                                        <div class=\"_4bqf _6biq _6bir\" tabindex=\"0\" role=\"button\" style=\"border-color: rgb(234, 82, 105); color: rgb(234, 82, 105);\">Có</div>");
						//sbPostback.AppendLine("                                                                                    </div>");
						sbPostback.AppendLine("                                                                                </div>");
						sbPostback.AppendLine("                                                                            </div>");
						...
						if (result.ButtonPostback.Count >= 4)
						{
							sbPostback.AppendLine("                                                                        <a class=\"_32rk _32rg _1cy6 btn_back_carousel\" href=\"#\" style=\"display:none;\">");
							sbPostback.AppendLine("                                                                            <div direction=\"backward\" class=\"_10sf _5x5- _5x60\">");
							sbPostback.AppendLine("                                                                                <div class=\"_5x6d\">");
							sbPostback.AppendLine("                                                                                    <div class=\"_3bwv _3bww\">");
							sbPostback.AppendLine("                                                                                        <div class=\"_3bwy\">");
							sbPostback.AppendLine("                                                                                            <div class=\"_3bwx\"><i class=\"_3-8w img sp_bfeq6p sx_c4c7bc\" alt=\"\"></i></div>");
							sbPostback.AppendLine("                                                                                        </div>");
							sbPostback.AppendLine("                                                                                    </div>");
							sbPostback.AppendLine("                                                                                </div>");
							sbPostback.AppendLine("                                                                            </div>");
							sbPostback.AppendLine("                                                                        </a>");

							sbPostback.AppendLine("                                                                        <a class=\"_32rk _32rh _1cy6 btn_next_carousel\" href=\"#\">");
							sbPostback.AppendLine("                                                                            <div direction=\"forward\" class=\"_10sf _5x5_\">");
							sbPostback.AppendLine("                                                                                <div class=\"_5x6d\">");
							sbPostback.AppendLine("                                                                                    <div class=\"_3bwv _3bww\">");
							sbPostback.AppendLine("                                                                                        <div class=\"_3bwy\">");
							sbPostback.AppendLine("                                                                                            <div class=\"_3bwx\">");
							sbPostback.AppendLine("                                                                                                <i class=\"_3-8w img sp_RQ3p_x3xMG3 sx_dbbd74\" alt=\"\"></i>");
							sbPostback.AppendLine("                                                                                            </div>");
							sbPostback.AppendLine("                                                                                        </div>");
							sbPostback.AppendLine("                                                                                    </div>");
							sbPostback.AppendLine("                                                                                </div>");
						...
						result.Postback = sbPostback.ToString();
					}
