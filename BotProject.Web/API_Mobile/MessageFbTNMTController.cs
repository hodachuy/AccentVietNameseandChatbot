...
namespace BotProject.Web.API_Webhook
{
    ...
    /// nền tảng facebook.
    /// </summary>
    public class MessageFbTNMTController : ApiController
    {
        // appSettings
        string pageToken = "";
        string appSecret = "";
        ...
        private BotServiceTNMT _botService;
        ...
        public MessageFbTNMTController(IApplicationFacebookUserService appFacebookUser,
