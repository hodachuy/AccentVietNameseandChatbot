...
namespace BotProject.Web.API_Webhook
{
    public class KioskController : ApiControllerBase
    {
        ...
        //    if (plUserDb != null && (plUserDb.PredicateName != "Admin_Contact"))
        //    {
        //        if (plUserDb.Age != 0)
        //        {
        ...
        //                _appPlatformUser.Update(plUserDb);
        //                _appPlatformUser.Save();
        //                return await MessageResponse(plUserDb.CardConditionWithInputTextPattern, senderId, botId, typeRequest);
        ...
        //            {
        //                plUserDb.CardStepPattern = "postback_card_" + cardDb.CardStepID;
        //                return await MessageResponse(plUserDb.CardStepPattern, senderId, botId,typeRequest, true);
        //            }
        //            //_lstBotReplyResponse = new List<string>();
        //            return await Task.FromResult<List<string>>(_lstBotReplyResponse);
        //        }
